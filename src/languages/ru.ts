...
export const ru: ILanguageDOM = {
    ...
    about: {
        ...
        hard: {
            ...
            descriptionBottom: "Следующие навыки были получены из разных YouTube-каналов",
        ...
        soft: {
            title: "Soft skills",
            descriptionTop: "Личностные качества",
            skillTop1: "Ответственное отношение к работе",
            skillTop2: "Интерес к разработке",
            skillTop3: "Обучаемость",
            skillTop4: "Хорошие письменные и устные коммуникативные навыки",
            skillTop5: "Желание работать и зарабатывать деньги",
            descriptionBottom: "Уровень английского",
            skillBottom1: "A2/B1",
            skillBottom2: "(продолжаю обучение)",
        },
        general: {
            title: "Общая информация",
            skillTop1: "Полный возраст: 41",
            skillTop2: "Номер телефона: +38 (093) 410-45-12",
    ...
    footer: {
        ...
        form: {
            ...
            privacyLabel: "Я согласен(а)",
            privacyLink: "с политикой конфиденциальности",
